...
class_names = [
    ...
    'bicycle', 'motor', 'fork_truck', 'travel_trailer', 'pedestrian',
    'rider', 'animal', 'stacked_trolleys', 'non-motor_vehicle_group',
    'crowd', 'cement_column', 'bollard', 'folding_warning_sign',
    'traffic_cone', 'parking_lock_open', 'parking_lock_close',
    'fire_hydrant_air', 'fire_hydrant_gnd','cement_sphere', 'water_barrier',
    'parking_lot_gate_open', 'parking_lot_gate_close', 'trolley',
    'charging_pile', 'reflector', 'distribution_box', 'single_fence',
    'multi_fence', 'trash_can','parking_sign', 'triangle_warning',
    'crash_barrel']
...
# Data
dataset_type = 'CylBevDataset'
data_root = 'data/bev_parking/'
