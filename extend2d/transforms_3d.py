...
from .transforms import RandomCrop, RandomFlip
from .auto_augment import Rotate
from ..builder import PIPELINES
from common.core.bbox import box_np_ops
from common.core.bbox.structures.lidar_box3d import LiDARInstance3DBoxes
from common.core.bbox.structures.depth_box3d import DepthInstance3DBoxes
...
class RandomRotate3D(Rotate):
    ...
    def __init__(self, range, **kwargs):
        super(RandomRotate3D, self).__init__(**kwargs)
        self.range = range

    def __call__(self, results):
        self.angle = np.random.uniform(self.range[0], self.range[1])
        super(RandomRotate3D, self).__call__(results)
