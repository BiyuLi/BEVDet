...
class CylBevDataset(Custom3DDataset):
    r"""CylBevDataset Dataset.
    Args:
    ...
    #                'cement_sphere', 'water_barrier', 'parking_lot_gate_open',
    #                'parking_lot_gate_close', 'trolley', 'charging_pile', 'reflector',
    #                'distribution_box', 'single_fence', 'multi_fence', 'trash_can',
    #                'parking_sign', 'triangle_warning', 'crash_barrel'
    #                ]
    CLASS_NAMES = VEHICLE_CLASSES + PERSON_CLASSES + RIDER_CLASSES
    BRANCH_CLASSES = ['vehicle', 'pedestrian', 'rider']
    ...
    def __init__(self,
        ...
        self.stereo = stereo
        self.CLASSES = self.get_classes(self.CLASS_NAMES)
        self.cat2id = {name: i for i, name in enumerate(self.CLASSES)}
        self.branch2label = {name: i for i, name in enumerate(self.BRANCH_CLASSES)}
